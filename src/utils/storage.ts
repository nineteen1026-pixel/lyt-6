...
export function getInitialGameState(): GameState {
  ...
  return {
    ...
    collectedClues: [],
    collectedClueTimestamps: {},
    discoveredConnections: [],
    discoveredConnectionTimestamps: {},
    unlockedEndings: [],
...
function migrateSavedGame(savedGame: SavedGameV1 | SavedGameV2 | SavedGameV3 | SavedGameV4 | SavedGameV5 | SavedGameV6 | SavedGameV7 | SavedGameV8 | SavedGame): GameState | null {
  ...
  if (version === SAVE_VERSION) {
    ...
    if (!(state as any).collectedClueTimestamps) (state as any).collectedClueTimestamps = {}
    if (!(state as any).discoveredConnectionTimestamps) (state as any).discoveredConnectionTimestamps = {}
